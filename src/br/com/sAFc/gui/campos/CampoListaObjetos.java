...
public abstract class CampoListaObjetos extends CampoFormularioSAFC {



	public CampoListaObjetos(FormularioAbstrato formulario) {
	...
	public abstract ObjetoNegocio[] getObjetosNegocio();
